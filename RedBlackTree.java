...
public class RedBlackTree<T extends Comparable<T>> {
    ...
    RBTreeNode<T> rotateRight(RBTreeNode<T> node) {
        // YOUR CODE HERE------------------------------------------------------------------------
        RBTreeNode rotator = node.left;
        boolean oldLeftColor = node.left.isBlack;
        RBTreeNode rotatorRight = rotator.right;
        boolean oldColor = node.isBlack;
        rotator.right = node;
        node.left = rotatorRight;
        rotator.right.isBlack = oldLeftColor;
        rotator.isBlack = oldColor;
        //RBTreeNode rotator = node;
        //node = node.left;
        //node.left = rotator;
    ...
    RBTreeNode<T> rotateLeft(RBTreeNode<T> node) {
        // YOUR CODE HERE------------------------------------------------------------------------
        RBTreeNode rotator = node.right;
        boolean oldRightColor = node.right.isBlack;
        RBTreeNode rotatorLeft = rotator.left;
        boolean oldColor = node.isBlack;
        rotator.left = node;
        node.right = rotatorLeft;
        rotator.left.isBlack = oldRightColor;
        rotator.isBlack = oldColor;
        return rotator;
    }
    ...
    private RBTreeNode<T> insert(RBTreeNode<T> node, T item) {
        ...
        //RBTreeNode(boolean black, T value, RBTreeNode<T> lft, RBTreeNode<T> rght)

        // Insert (return) new red leaf node.
        if (node == null) {
            // YOUR CODE HERE------------------------------------------------------------------------
            // maybe not having it be added as node.left, maybe just returning the new node
