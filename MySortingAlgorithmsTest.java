...
public class MySortingAlgorithmsTest {
    ...
    private SortingAlgorithm[] algorithms = {
        new MySortingAlgorithms.InsertionSort(), // necessary
        new MySortingAlgorithms.SelectionSort(), // necessary
        new MySortingAlgorithms.MergeSort()}; // necessary
        // new MySortingAlgorithms.CountingSort(),
        // new MySortingAlgorithms.HeapSort(),
        //new MySortingAlgorithms.QuickSort(),
       // new MySortingAlgorithms.LSDSort()}; // necessary
